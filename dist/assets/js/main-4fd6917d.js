...
// module
exports.push([module.i, "._2Gx2cUTbmlBvZx7W4XtmA7{background:#9acd32}#_3z_8xok5NUCnk2DDr8KC3{background:bisque}.Zk3wQHLLnTFb8HxOQrhd{background:#8a2be2}", ""]);

// exports
exports.locals = {
	"ot": "_2Gx2cUTbmlBvZx7W4XtmA7",
	"hell": "_3z_8xok5NUCnk2DDr8KC3",
	"test": "Zk3wQHLLnTFb8HxOQrhd"
};
...
var B = function (_React$Component) {
    ...
    _createClass(B, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(_c2.default, null);
        }
    }]);
...
if (true) {
    module.hot.accept(8, function () {
        // 第一个参数是引入的路径(注意是引入过的路径)，第二个参数是改变后要做的行为
...
//# sourceMappingURL=main-4fd6917d.js.map